function restartAnimations() {
  setTimeout(function () {
    ...
    document.getElementById("logo").style.animation =
      "0.4s rightLeft 0.4s ease forwards,0.4s rightLeft 8s ease forwards reverse";
    document.getElementById("first-title").style.animation =
      "0.4s bottomTop 1.4s ease forwards,0.4s bottomTop 2.7s ease forwards reverse";
    ...
    document.getElementById("first-text").style.animation =
      "0.4s bottomTop 3.2s ease forwards,0.4s bottomTop 4.5s ease forwards reverse";
    ...
    document.getElementById("disclaimer").style.animation =
      "0.4s bottomTop 5s ease forwards,0.4s bottomTop 7s ease forwards reverse";
