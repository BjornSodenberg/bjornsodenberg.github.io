function restartAnimations() {
  setTimeout(function () {
    ...
    document.getElementById("third-title").style.animation = "0.4s rightLeft 1.8s ease forwards,0.4s rightLeft 5s ease forwards reverse";
    document.getElementById("fourth-title").style.animation = "0.4s rightLeft 2s ease forwards,0.4s rightLeft 5s ease forwards reverse";
