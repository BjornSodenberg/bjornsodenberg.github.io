function restartAnimations() {
  setTimeout(function () {
    ...
    document.getElementById("content-text").style.animation =
      "0.7s showBox 2s ease forwards, 0.7s showBox 9s ease forwards reverse";
    document.getElementById(
      "phone-container"
    ).style.animation = `0.7s showPhone 3s ease forwards,
      0.7s showPhone 9s ease forwards reverse`;
    document.getElementById(
      "rating-box"
    ).style.animation = `1s rating-box 4s ease forwards,
      1s rating-box 8.5s ease forwards reverse`;
    document.getElementById("disclaimer").style.animation =
      "0.7s showBox 9.5s ease forwards";
    document.getElementById("screen").style.animation =
      "0.7s showScreen 1s ease forwards reverse, 1s showScreen 15s ease forwards";
    document.getElementById(
      "logo"
    ).style.animation = `0.7s logoScale 1s ease forwards reverse,
      0.7s showBox 9s ease forwards reverse, 0.7s showBox 15.2s ease forwards,
      0.7s logoScale 15s ease forwards`;
