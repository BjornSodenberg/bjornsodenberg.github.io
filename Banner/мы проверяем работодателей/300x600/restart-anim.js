function restartAnimations() {
  setTimeout(function () {
    ...
    document.getElementById("fourth-title").style.animation = "none";
    document.getElementById("fifth-title").style.animation = "none";
    ...
    document.getElementById("fourth-title").style.animation = "0.4s rightLeft 2s ease forwards,0.4s rightLeft 7s ease forwards reverse";
    document.getElementById("fifth-title").style.animation = "0.4s rightLeft 2.2s ease forwards,0.4s rightLeft 7s ease forwards reverse";
    ...
    document.getElementById("disclaimer").style.animation = "0.4s bottomTop 3s ease forwards, 0.4s bottomTop 7s ease forwards reverse";
    document.getElementById("age").style.animation = "0.4s bottomTop 3s ease forwards, 0.4s bottomTop 7s ease forwards reverse";
